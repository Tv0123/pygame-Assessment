...
Author: Thomas Vrkic
Date: 6/10/24
Description: Manages the legal menu
"""
...
def render(canvas):
    ...
    rf.text(canvas, u.titleFont, u.blue, 640, 90, "Legal Disclaimer")
    rf.text(canvas, u.defaultFont, u.blue, 640, 150, "A certified hood classic, by Thomas")

    button_width, button_height = 300, 50
 
    paragraph = "This game is purely for artistic and entertainment purposes only\nand should not be recreated in real life!"
    ...
    for i, line in enumerate(lines):
        rf.text(canvas, u.defaultFont, u.blue, 640, start_y + i * line_height, line)
